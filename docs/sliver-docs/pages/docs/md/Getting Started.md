Download the latest server [release](https://github.com/Oni-kuki/sliver/releases) for your platform, and just run the binary. That's it, you're pretty much done.
