...
```
dlv debug \
--build-flags="-tags osusergo,netgo,go_sqlite,server -ldflags='-X github.com/Oni-kuki/sliver/client/version.Version=1.1.2 -X github.com/Oni-kuki/sliver/client/version.CompiledAt=Never -X github.com/Oni-kuki/sliver/client/version.GithubReleasesURL=github.com -X github.com/Oni-kuki/sliver/client/version.GitCommit=aabbcc -X github.com/Oni-kuki/sliver/client/version.GitDirty=Dirty'" \
--headless \
--listen=:2345 \
--api-version=2 \
--log \
github.com/Oni-kuki/sliver/server
```
...
```json
{
  ...
  "args": [
    "debug",
    "--build-flags=\"-tags osusergo,netgo,go_sqlite,server -ldflags='-X github.com/Oni-kuki/sliver/client/version.Version=0.0.0 -X github.com/Oni-kuki/sliver/client/version.CompiledAt=Never -X github.com/Oni-kuki/sliver/client/version.GithubReleasesURL=https://api.github.com/repos/BishopFox/sliver/releases -X github.com/Oni-kuki/sliver/client/version.GitCommit=debug -X github.com/Oni-kuki/sliver/client/version.GitDirty=Dirty -X github.com/Oni-kuki/sliver/client/assets.DefaultArmoryPublicKey=RWSBpxpRWDrD7Fe+VvRE3c2VEDC2NK80rlNCj+BX0gz44Xw07r6KQD9L -X github.com/Oni-kuki/sliver/client/assets.DefaultArmoryRepoURL=https://api.github.com/repos/sliverarmory/armory/releases'\"",
    "--headless",
    "--listen=:8844",
    "--api-version=2",
    "--log",
