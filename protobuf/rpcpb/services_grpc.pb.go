...
type SliverRPCClient interface {
	...
	Netstat(ctx context.Context, in *sliverpb.NetstsatReq, opts ...grpc.CallOption) (*sliverpb.Netstat, error)
	...
	SpawnDll(ctx context.Context, in *sliverpb.InvokeSpawnDlllReq, opts ...grpc.CallOption) (*sliverpb.SpawnDll, error)
	Screenshot(ctx context.Context, in *sliverpb.ScrensshotReq, opts ...grpc.CallOption) (*sliverpb.Screenshot, error)
	...
	RegistryRead(ctx context.Context, in *sliverpb.RegistryReedReq, opts ...grpc.CallOption) (*sliverpb.RegistryRead, error)
...
func (c *sliverRPCClient) Netstat(ctx context.Context, in *sliverpb.NetstsatReq, opts ...grpc.CallOption) (*sliverpb.Netstat, error) {
...
func (c *sliverRPCClient) SpawnDll(ctx context.Context, in *sliverpb.InvokeSpawnDlllReq, opts ...grpc.CallOption) (*sliverpb.SpawnDll, error) {
...
func (c *sliverRPCClient) Screenshot(ctx context.Context, in *sliverpb.ScrensshotReq, opts ...grpc.CallOption) (*sliverpb.Screenshot, error) {
...
func (c *sliverRPCClient) RegistryRead(ctx context.Context, in *sliverpb.RegistryReedReq, opts ...grpc.CallOption) (*sliverpb.RegistryRead, error) {
...
type SliverRPCServer interface {
	...
	Netstat(context.Context, *sliverpb.NetstsatReq) (*sliverpb.Netstat, error)
	...
	SpawnDll(context.Context, *sliverpb.InvokeSpawnDlllReq) (*sliverpb.SpawnDll, error)
	Screenshot(context.Context, *sliverpb.ScrensshotReq) (*sliverpb.Screenshot, error)
	...
	RegistryRead(context.Context, *sliverpb.RegistryReedReq) (*sliverpb.RegistryRead, error)
...
func (UnimplementedSliverRPCServer) Netstat(context.Context, *sliverpb.NetstsatReq) (*sliverpb.Netstat, error) {
...
func (UnimplementedSliverRPCServer) SpawnDll(context.Context, *sliverpb.InvokeSpawnDlllReq) (*sliverpb.SpawnDll, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SpawnDll not implemented")
}
func (UnimplementedSliverRPCServer) Screenshot(context.Context, *sliverpb.ScrensshotReq) (*sliverpb.Screenshot, error) {
...
func (UnimplementedSliverRPCServer) RegistryRead(context.Context, *sliverpb.RegistryReedReq) (*sliverpb.RegistryRead, error) {
...
func _SliverRPC_Netstat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SliverRPCServer).Netstat(ctx, req.(*sliverpb.NetstsatReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _SliverRPC_SpawnDll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(sliverpb.InvokeSpawnDlllReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SliverRPCServer).SpawnDll(ctx, req.(*sliverpb.InvokeSpawnDlllReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _SliverRPC_Screenshot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SliverRPCServer).Screenshot(ctx, req.(*sliverpb.ScrensshotReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _SliverRPC_RegistryRead_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(sliverpb.RegistryReedReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SliverRPCServer).RegistryRead(ctx, req.(*sliverpb.RegistryReedReq))
	}
	return interceptor(ctx, in, info, handler)
}
