...
[![Release](https://github.com/Oni-kuki/sliver/actions/workflows/autorelease.yml/badge.svg)](https://github.com/Oni-kuki/sliver/actions/workflows/autorelease.yml) [![Go Report Card](https://goreportcard.com/badge/github.com/Oni-kuki/sliver)](https://goreportcard.com/report/github.com/Oni-kuki/sliver) [![License: GPL v3](https://img.shields.io/badge/License-GPLv3-blue.svg)](https://www.gnu.org/licenses/gpl-3.0)
...
For PRs containing bug fixes specific to Sliver v1.5, please target the [`v1.5.x/master` branch](https://github.com/Oni-kuki/sliver/tree/v1.5.x/master).
...
Download the latest [release](https://github.com/Oni-kuki/sliver/releases) and see the Sliver [wiki](https://sliver.sh/docs?name=Getting+Started) for a quick tutorial on basic setup and usage. To get the very latest and greatest compile from source.
...
Please checkout the [wiki](https://sliver.sh/), or start a [GitHub discussion](https://github.com/Oni-kuki/sliver/discussions). We also tend to hang out in the #golang Slack channel on the [Bloodhound Gang](https://bloodhoundgang.herokuapp.com/) server.
